      ...
      <div className="container col-xl-10 col-xxl-8 px-4 py-5">
        <div className="row align-items-center g-lg-5 py-5">
          <div className="col-lg-7 text-center text-lg-start">
            ...
            <p className="col-lg-10 fs-4">It's fast and easy to get started! Fill out the form below, and within minutes, you’ll have access to all the tools you need to manage your files securely and efficiently.!</p>
          </div>
